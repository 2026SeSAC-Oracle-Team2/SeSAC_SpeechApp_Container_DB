...
-- 스키마: SPEECHAPP_USER
-- 테이블: CONTENT_TYPE, SESSION, TURN, TURN_IMAGE, VOICE_RECORD
-- v1.8 (2026-09-01): P3-20 session/voice schema
-- ============================================================
...
-- SESSION
-- -----------------------------------------------------------
CREATE TABLE speechapp_user.session (
...
CREATE INDEX idx_session_user_id ON speechapp_user.session(user_id);
